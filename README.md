# wordcloud2.js [![spm version](http://spmjs.io/badge/wordcloud)](http://spmjs.io/package/wordcloud)

    wordcloud2.js, tag cloud/Wordle presentation on 2D canvas or HTML
    (what I do is making it work fine for spmjs.)
